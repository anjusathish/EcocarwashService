...
class CleanerServiceHelper {
    
    class func request<T: Codable>(router: CleanerServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
